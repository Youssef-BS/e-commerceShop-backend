...
import com.shops.shops.service.image.IImageService;
import com.shops.shops.service.image.ImageService;
...
public class ImageController {
    ...
    public ResponseEntity<ApiResponse> saveImages(@RequestParam  List<MultipartFile> files ,@RequestParam Long productId) {
        try {
            ...
            return ResponseEntity.status(HttpStatusCode.valueOf(500)).body(new ApiResponse("Upload failed !" , e.getMessage()));
        }
